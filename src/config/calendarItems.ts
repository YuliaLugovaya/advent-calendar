...
const calendarItems = [
  ...
  },
  {
    ...
    id: "16",
    title: "День новогодних мультфильмов",
    task: "Сегодня выбери интересный новогодний мультик и посмотри его. Это может быть сборник мультиков про зиму или большой длинынй мультфильм. На сайте есть подборка, можно посмотреть и выбрать.",

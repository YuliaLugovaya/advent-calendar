...
const calendarItems = [
  ...
  },
  {
    ...
    task: "Продолжи традицию просмотра новогодних фильмов и мультфильмов. Выбери любой мультик и посмотри его с родными. На сайте есть подборка, можно посмотреть и выбрать.",
  ...
  },
  {
    ...
    task: "Сегодня тебе нужно разучить и спеть любую песню про зиму, Новый год или Рождество.",
  ...
  },
  {
    ...
    id: "15",
    title: "День историй про Новый год",
    task: "Сегодня ты узнаешь, как называют Деда Мороза в разных странах мира. Вперед к интересным знаниям! На сайте есть статья, которая поможет тебе разобраться в этом важном вопросе.",
    ball: ballDecemberFifteenth,
    colorBg: colors.violet,
    date: format(new Date(currentYear, 11, 15), "yyyy-MM-dd"),
    link: "/advent-calendar/santas",
  },
  {
    icon: tree,
    text: "16",
    id: "16",
    title: "День новогодних мультфильмов",
    task: "Сегодня выбери интересный новогодний мультик и посмотри его. Это может быть сборник мультиков про зиму или большой длинный мультфильм. На сайте есть подборка, можно посмотреть и выбрать.",
  ...
  },
  {
    ...
    id: "17",
    title: "День новогодних фильмов",
    task: "Продолжи традицию просмотра новогодних фильмов. Не забывай, что на сайте есть подборка, где можно посмотреть и выбрать фильм.",
  ...
  },
  {
    ...
    task: "Сегодня устрой новогодний музыкальный день! Найди интересные новогодние и рождественские песни, послушай их и потанцуй.",
  ...
  },
  {
    ...
    link: "/advent-calendar/world-traditions",
  },
  {
    icon: ring,
    text: "21",
    id: "21",
    title: "Вкусный стол",
    task: "Сегодня самое время подумать, какие блюда ты вместе с родными будешь готовить на Новый год. Составь список желаемых блюд, напиши рецепты, можно даже составить список продуктов.",
  ...
  },
  {
    ...
    task: "Сегодня выбери фильм или мультик именно про Рождество, потому что этот праздник уже через пару дней. На сайте есть подборка, можно посмотреть и выбрать.",
